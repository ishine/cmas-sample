...
// TODO: upgrade you android ndk to support posix apis
/*
1. set APP_PLATFORM := android-17 or above in Application.mk
2. upgrade your ndk from android-ndk-r9b to android-ndk-r10e
*/
#  define KALDI_MEMALIGN(align, size, pp_orig) \
     (memalign(align, size))
